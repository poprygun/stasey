...
public class MQMessagePropertiesSample {
  ...
  public static final String sccsid = "@(#) MQMBID sn=p750-006-160226 su=_TugkMNyhEeWwq9y6KvwQ0Q pn=MQJavaSamples/wmqjava/MQMessagePropertiesSample.java"; //$NON-NLS-1$
