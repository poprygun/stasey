...
public class MQTest extends java.applet.Applet implements ActionListener {
  ...
  static final String sccsid = "@(#) MQMBID sn=p750-006-160226 su=_TugkMNyhEeWwq9y6KvwQ0Q pn=MQJavaSamples/wmqjava/MQTest.java";
  ...
  public void init() {
    ...
    if (!initialized) {
      ...
      Panel buttonPanel = new Panel();
      buttonPanel.setLayout(new FlowLayout(FlowLayout.CENTER, 15, 15));
      testConnectionBtn = new Button(messageMgr.getMessage(2));
      buttonPanel.add(testConnectionBtn);
      closeBtn = new Button(messageMgr.getMessage(3));
      buttonPanel.add(closeBtn);
      add(buttonPanel);
